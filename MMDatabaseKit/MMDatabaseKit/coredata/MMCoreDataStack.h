...
@property (nonatomic, strong, readonly) NSManagedObjectContext *backgroundContext;  ///< Each invocation will generate a new context uses main context as parent context.
