...
{
    MMDatabaseTypeNone,
    MMDatabaseTypeOriginal,
    MMDatabaseTypeFMDB,
    MMDatabaseTypeCoreData,
    MMDatabaseTypeSqlitePersistentObject
}MMDatabaseType;

@interface MMDatabaseManager : NSObject

@property (nonatomic, assign) MMDatabaseType         type;

@property (nonatomic, assign) BOOL                   opened;

@property (nonatomic, strong, readonly) MMDatabase  *database;
