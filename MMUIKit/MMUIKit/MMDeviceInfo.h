 ...
 *
 * All subsequent calls to MMDeviceInfo methods will use this cached information.
 *
 ...
 *
 * @code
 *  [MMDeviceInfo beginCachedDeviceInfo];
 *
 *  // All calls to MMDeviceInfo methods here will use the information retrieved when
 *  // beginCachedDeviceInfo was called.
 *
 *  [MMDeviceInfo endCachedDeviceInfo];
 * @endcode
 */
