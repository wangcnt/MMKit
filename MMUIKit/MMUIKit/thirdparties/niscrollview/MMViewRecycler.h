 ...
 * MMViewRecycler implements this recycling functionality, allowing you to implement recycling
 ...
 *
@code
for (UIView<MMRecyclableView>* view in visibleViews) {
 ...
 *
@code
UIView<MMRecyclableView>* view = [viewRecycler dequeueReusableViewWithIdentifier:reuseIdentifier];
if (nil == view) {
  // Allocate a new view that conforms to the MMRecyclableView protocol.
  view = [[[...]] autorelease];
}
 ...
 */
@interface MMViewRecycler : NSObject
...
/**
 * The MMRecyclableView protocol defines a set of optional methods that a view may implement to
 * handle being added to a MMViewRecycler.
 */
@protocol MMRecyclableView <NSObject>
...
/**
 * A simple implementation of the MMRecyclableView protocol as a UIView.
 *
 ...
 */
@interface MMRecyclableView : UIView <MMRecyclableView>
 ...
 *
 * @fn MMViewRecycler::dequeueReusableViewWithIdentifier:
 ...
 *
 * @fn MMRecyclableView::initWithReuseIdentifier:
 ...
 *
 * Used by MMViewRecycler to pool this view into a group of similar recycled views.
 *
 * @fn MMRecyclableView::reuseIdentifier
 */
